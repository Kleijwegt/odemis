...
class EBeamScanner(model.Emitter):
    ...
    def __init__(self, name, role, parent, **kwargs):
        ...
        self.dwellTime = model.FloatContinuous(4e-7, (4e-7, 1e-4), unit='s')
    ...
    def _calc_calibration_sampling_period(self, total_line_scan_time, system_clock_period, descanner_clock_period):
        ...
        setpoints is limited to maximum 9000 points. Depending on the total line scanning time the calibration
        ...
        """
        # TODO MAX_NMBR_POINT value of 9000 is not sufficient for the entire range of the dwell time, this value
        #  needs to be increased on the ASM HW.
        MAX_NMBR_POINT = 9000  # Constant maximum number of setpoints
        ...
        # The minimal number of ticks of the system clock period to get a sampling period with max 9000 setpoints
